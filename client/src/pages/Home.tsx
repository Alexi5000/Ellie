const AVATAR_IMG =
  "https://private-us-east-1.manuscdn.com/sessionFile/gWmyXpFEvHo0kObvks0qCF/sandbox/ZtI9hC7CC6zZ9rytJNsjtt-img-4_1771449544000_na1fn_ZWxsaWUtYXZhdGFy.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=SIRRSC92Ni0xdTZyZCjSHoudn50ifXmKQh8APzVgJOj1y0Y8Pl04pWjvFdmsvonU9poFlKHq6QPozjLP277Yac9dZvDj8ftxO25LPVBkWAJGxczpMilQGhr~VIuql07swEEO56cjUihwh4R2shJ4X-Fntq9BlthIGzXEigdDgQksxQDNXfHs8TteURZ~Eq2ECDt6caEkCl4FluUVkoEWJ3Tt2GNjBMXxnF~EtE9a1ipuNVLHvcfYJEn--Q6pXicClMkB4zYo2gsr1HAK61siQBdvWS87XnR9xBJ8lRFm0nAQAwUaP-tjpp8eToyDWl0wahj5pvq1-Rtmdk02Zhs3aw__";
    ...
    <div className="flex items-center justify-center gap-[3px] h-12">
      {Array.from({ length: bars }).map((_, i) => (
        <div
          ...
          style={{
            height: active
              ? `${12 + Math.sin(i * 0.7) * 20 + Math.random() * 16}px`
              : "4px",
            background: active
            ...
            animation: active
              ? `waveformPulse ${0.8 + Math.random() * 0.8}s ease-in-out infinite`
              : "none",
          }}
        />
      ))}
      ...
      {Array.from({ length: 20 }).map((_, i) => (
        <div
          ...
          style={{
            ...
            background:
              i % 3 === 0
                ? "oklch(0.82 0.15 75 / 30%)"
                : "oklch(0.78 0.12 195 / 20%)",
  ...
  return (
    <div className="text-center">
      <div className="font-display text-4xl lg:text-5xl font-bold text-amber text-glow-amber">
        {value}
        <span className="text-cyan text-2xl lg:text-3xl">{suffix}</span>
      </div>
              ...
              >
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full glass-panel text-xs text-amber mb-6">
                  ...
                  <span className="font-medium">
                    State-of-the-Art Video Intelligence
                  </span>
                </div>
                ...
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-2xl mb-8 font-body">
                  Upload any video. Ask anything. Ellie instantly analyzes every
                  frame, transcribes every word, detects every sound, and
                  remembers every detail — then talks to you about it.
                </p>
                    ...
                    {[
                      ...
                      <span
                        ...
                        style={{
                          background:
                            i === 0
                              ? "oklch(0.82 0.15 75 / 10%)"
                              : i === 1
                                ? "oklch(0.78 0.12 195 / 10%)"
                                : "oklch(0.7 0.14 150 / 10%)",
                          color:
                            i === 0
                              ? "oklch(0.82 0.15 75)"
                              : i === 1
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Ellie doesn't just watch your videos — she sees, hears,
              understands, and remembers. A complete multimodal analysis
              pipeline in one conversation.
            </p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <FeatureCard
              icon={Eye}
              title="Frame Captioning"
              description="Every frame analyzed with Gemini Vision. Scene descriptions, object detection, text extraction, and visual context — all indexed and searchable."
              delay={0}
            />
            <FeatureCard
              icon={Ear}
              title="Audio Transcription"
              description="Whisper-powered speech-to-text with speaker diarization. Every word captured with timestamps, speaker labels, and confidence scores."
              delay={0.06}
            />
            <FeatureCard
              icon={FileAudio}
              title="Audio Detection"
              description="Sound event detection beyond speech. Music, ambient noise, emotional tone, and environmental audio classified and timestamped."
              delay={0.12}
            />
            <FeatureCard
              icon={Brain}
              title="Conversational Memory"
              description="Tiered memory system — short-term, working, and long-term. Ellie remembers your previous questions and builds on past analysis."
              delay={0.18}
            />
            <FeatureCard
              icon={Mic}
              title="Voice Interaction"
              description="Talk to Ellie naturally. Sub-500ms voice response with streaming STT, intelligent endpointing, and empathetic TTS synthesis."
              delay={0.24}
            />
            <FeatureCard
              icon={Video}
              title="Instant Analysis"
              description="Upload any video format. Parallel processing pipeline extracts frames, audio, and metadata simultaneously for near-instant results."
              delay={0.3}
            />
          </div>
        </div>
      ...
      >
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-display text-4xl lg:text-5xl font-bold text-foreground mb-4">
              Three Steps to{" "}
              <span className="text-cyan text-glow-cyan">Intelligence</span>
            </h2>
          </motion.div>
            ...
            {[
              {
                ...
                title: "Upload",
                description:
                  "Drag and drop any video. MP4, MOV, AVI, WebM — we handle it all. No size limits, no format restrictions.",
                icon: Upload,
                color: "amber",
              },
              {
                ...
                title: "Analyze",
                description:
                  "Our parallel pipeline extracts frames, transcribes audio, detects scenes, and builds a complete understanding in seconds.",
                icon: Zap,
                color: "cyan",
              },
              {
                ...
                title: "Converse",
                description:
                  "Ask anything about your video. Type or speak. Ellie responds with precise answers, timestamps, and visual references.",
                icon: MessageSquare,
                color: "amber",
              },
            ].map((item, i) => (
            ...
            <div>
              ...
              >
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  ...
                  Streaming architecture, intelligent caching, and parallel
                  processing ensure Ellie responds before you finish your
                  thought.
                </p>
              </motion.div>
                ...
                {[
                  {
                    ...
                    desc: "20ms audio chunks, parallel STT/LLM/TTS processing",
                  },
                  {
                    icon: Shield,
                    title: "Circuit Breaker",
                    desc: "Automatic failover between AI providers for 99.99% uptime",
                  },
                  {
                    icon: Clock,
                    title: "Predictive Processing",
                    desc: "Starts generating responses on partial transcripts",
                  },
                  {
                    icon: Brain,
                    title: "Intelligent Routing",
                    desc: "Fast models for simple queries, powerful models for complex analysis",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="font-display text-4xl lg:text-6xl font-bold text-foreground mb-6">
              Ready to See{" "}
              <span className="text-amber text-glow-amber">Everything</span>?
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
              Upload your first video and experience the most advanced AI video
              analysis agent ever built.
            </p>
            <Button
              onClick={() => navigate("/analyze")}
              size="lg"
      ...
      <footer className="border-t border-border/30 py-8">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            >
              Built with Gemini, Whisper, tRPC, Drizzle, and production
              readiness checks
            </button>
          </div>
        </div>
